    ...
    >
      <div className="flex flex-col items-center text-center pb-14 2xl:mx-52 xl:mx-32 lg:mx-20 gap-5">
        ...
        <p className="text-[#505072]">
          ...
          it the mice again musical approved
        </p>
      </div>
      ...
      >
        {data.map((items,index) => (
          <div key={index} className="flex flex-col gap-2 items-center p-8 justify-center rounded-xl bg-white">
            ...
            <div className="py-3 self-center 2xl:self-start ">
              <h1 className="text-[20px] font-semibold py-3">{items.Name}</h1>
              <p className="flex items-center text-[#505072]">{items.detail}</p>
            </div>
          </div>
        ))}
      </div>
